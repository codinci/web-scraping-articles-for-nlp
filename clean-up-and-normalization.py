...
#Read news articles from a JSON file
...
#Verb tokens that aren't stop words or punctuations
...
#spaCy - list of special characters to be removed 
#         _currency = r"\$
#         _punct = (r" ... ,,,, , : ; \!  \? \( \) [\] { \} < > _# \* &)
#         _quotes = r '\' " " < >'
...
with open('/home/davi3/Projects/PythonProjects/ForexInfo/articles.json') as json_file:
    ...
    with open("article_all.txt", "w") as text_file:
        ...
        for sentence in sentences:
            ...
            print("Stopwords and Punctuation Removal: " + sentence)
